...
<html lang="en">
  ...
  <body>
    <!-- navbar start -->
    <nav class="navbar">
      <a href="#" class="navbar-logo">Toko Buku <span style="color: gold; font-size: 2rem;">Palasari</span></a>
    ...
    <section id="dafMenu" class="dafMenu">
      ...
      <container class="row">
        ...
        <div style="display:flex; flex-direction:row">
            ...
            <p style="font-size: 2.5rem; color:gold;"><b><?= $baris["nama_buku"]?></b></p>
            <p><?= $baris["deskripsi"]?></p>
            <p style="color:#f3cb51;">Karya: <?= $baris["karya"]?></p>
            <a class="link" href="<?= $baris["link"]?>">Link</a>
            
            <br>
            <hr style="border: 1px solid brown; width: auto">
            </container>
        </div>
        <br>
            <body>
